        ...
        if($this->cidr() <= 30){
            ...
            for ($i=0; $i < $count; $i++) { 
                ...
                if ($endereco_intervalo[3] >= $intervalo1 AND $endereco_intervalo[3] <= $intervalo2) {
                    ...
                    $mensagem[$i] = "<b style='color: #557A95;'>" . $primeiroValor . '</b> -- <b class="bloco">' . $valorIntervalo1 . ' - '.$this->endereco().' - ' . $valorIntervalo2 . '</b> -- <b style="color: #557A95;">' . $segundoValor . "</b> <br>";

                    $host1 = $host1 + $broadcast[3] + 1;
                   
                }else{

                    $mensagem[$i] = "<b style='color: #557A95;'>" . $primeiroValor . '</b> -- <b class="bloco">' . $valorIntervalo1 . ' - ' . $valorIntervalo2 . '</b> -- <b style="color: #557A95;">' . $segundoValor . "</b> <br>";    
            ...
            for ($i=0; $i < $count; $i++) { 
                ...
                $mensagem[$i] = "<b style='color: #557A95;'>" . $primeiroValor . '</b> -- <b class="bloco">' . $valorIntervalo2 . ' - ' . $valorIntervalo1 . '</b> -- <b style="color: #557A95;">' . $segundoValor . "</b> <br>";
            ...
            for ($i=0; $i < $count; $i++) { 
                ...
                $mensagem[$i] = "<b style='color: #557A95;'>" . $Valor . '</b> -- <b class="bloco">' . $Valor . ' - ' . $Valor . '</b> -- <b style="color: #557A95;">' . $Valor . "</b> <br>";
